...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Explorer Boots", /obj/item/clothing/shoes/workboots/mining/explorer, 200),
		...
		new /datum/data/mining_equipment("KA Hyper Chassis", /obj/item/borg/upgrade/modkit/human_passthrough, 300),
