...
/datum/mod_theme/xenobio
	...
	armor = list(MELEE = 15, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 15, BIO = 100, FIRE = 50, ACID = 100, WOUND = 15)
	resistance_flags = FIRE_PROOF|ACID_PROOF
	slowdown_inactive = 0.75
	slowdown_active = 0.25
	allowed_suit_storage = list(
	...
	skins = list(
		"xenobio" = list(
			...
			HELMET_FLAGS = list(
				UNSEALED_CLOTHING = SNUG_FIT|THICKMATERIAL,
				UNSEALED_INVISIBILITY = HIDEFACIALHAIR|HIDESNOUT,
				SEALED_INVISIBILITY = HIDEMASK|HIDEEARS|HIDEHAIR||HIDEEYES|HIDEFACE,
				SEALED_COVER = HEADCOVERSMOUTH|HEADCOVERSEYES|PEPPERPROOF,
				SEALED_CLOTHING = STOPSPRESSUREDAMAGE,
			),
			CHESTPLATE_FLAGS = list(
