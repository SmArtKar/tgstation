...
/datum/unit_test/mecha_damage/Run()
	...
	var/obj/item/mecha_equipment/left_arm_equipment = demo_mech.equip_by_category[MECHA_L_ARM]
	...
	var/obj/item/mecha_equipment/right_arm_equipment = demo_mech.equip_by_category[MECHA_R_ARM]
