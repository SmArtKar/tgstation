...
/obj/item/reagent_containers/cup/glass/bottle/try_splash(mob/living/user, atom/target)
	...
	if(ishuman(target))
		...
		armor_block = H.run_armor_check(affecting, MELEE, "", "", armour_penetration, attack_type = MELEE_ATTACK) // For normal attack damage
		...
		armor_block = living_target.run_armor_check(affecting, MELEE, attack_type = MELEE_ATTACK)
