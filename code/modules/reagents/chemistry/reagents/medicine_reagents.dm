...
/datum/reagent/medicine/mutanite_solution
	...
	var/static/list/mutation_types = list(
		ORGAN_SLOT_HEART = /obj/item/organ/internal/heart/slime,
		ORGAN_SLOT_LUNGS = /obj/item/organ/internal/lungs/slime,
		ORGAN_SLOT_EYES = /obj/item/organ/internal/eyes/slime,
		ORGAN_SLOT_EARS = /obj/item/organ/internal/ears/slime,
		ORGAN_SLOT_TONGUE = /obj/item/organ/internal/tongue/slime,
		ORGAN_SLOT_LIVER = /obj/item/organ/internal/liver/slime,
		ORGAN_SLOT_STOMACH = /obj/item/organ/internal/stomach/slime,
		ORGAN_SLOT_APPENDIX = /obj/item/organ/internal/appendix/slime,
	)
