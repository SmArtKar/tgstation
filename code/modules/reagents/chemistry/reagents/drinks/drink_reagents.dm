...
/datum/reagent/consumable/tomatojuice/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	...
	if(affected_mob.get_burn_loss() && SPT_PROB(10, seconds_per_tick))
		if(affected_mob.apply_healing(1 * REM * seconds_per_tick, BURN, null, REAGENT_ATTACK, spread_damage = FALSE, updating_health = FALSE))
			return UPDATE_MOB_HEALTH
...
/datum/reagent/consumable/milk/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	if(affected_mob.get_brute_loss() && SPT_PROB(10, seconds_per_tick))
		if(affected_mob.apply_healing(1 * REM * seconds_per_tick, BRUTE, null, REAGENT_ATTACK, spread_damage = FALSE, updating_health = FALSE))
			. = UPDATE_MOB_HEALTH
...
/datum/reagent/consumable/soymilk/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	. = ..()
	if(affected_mob.get_brute_loss() && SPT_PROB(10, seconds_per_tick))
		if(affected_mob.apply_healing(1, BRUTE, null, REAGENT_ATTACK, spread_damage = FALSE, updating_health = FALSE))
			return UPDATE_MOB_HEALTH
...
/datum/reagent/consumable/cream/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	. = ..()
	if(SPT_PROB(10, seconds_per_tick) && affected_mob.apply_healing(1, BRUTE, null, REAGENT_ATTACK, spread_damage = FALSE, updating_health = FALSE))
		return UPDATE_MOB_HEALTH
...
/datum/reagent/consumable/soy_latte/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	...
	if(affected_mob.get_brute_loss() && SPT_PROB(10, seconds_per_tick))
		need_mob_update += affected_mob.apply_healing(1 * REM * seconds_per_tick, BRUTE, null, REAGENT_ATTACK, spread_damage = FALSE, updating_health = FALSE)
	if(need_mob_update)
		return UPDATE_MOB_HEALTH
