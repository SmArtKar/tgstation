...
/obj/structure/trap/eldritch/attacked_by(obj/item/weapon, mob/living/user, list/modifiers)
...
/obj/structure/trap/eldritch/tentacle/trap_effect(mob/living/victim)
	...
	carbon_victim.apply_damage(20, BRUTE, null, MAGIC_ATTACK, BODY_ZONE_R_LEG, source = src)
	carbon_victim.apply_damage(20, BRUTE, null, MAGIC_ATTACK, BODY_ZONE_L_LEG, source = src)
