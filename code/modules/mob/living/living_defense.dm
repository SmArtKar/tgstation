...
/mob/living/proc/run_armor_check(def_zone = null, attack_flag = SLASH, absorb_text = null, soften_text = null, armour_penetration, penetrated_text, silent = FALSE, weak_against_armour = FALSE, ranged = FALSE)
