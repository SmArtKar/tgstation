...
/datum/species/proc/stagger_combo(mob/living/carbon/human/user, mob/living/carbon/human/target, atk_verb = "hit", limb_accuracy = 0, armor_block = 0)
	...
	var/speaker = "<i><b>[/datum/aspect/half_light::name]</b>:</i>"
	switch(roll_them_bones)
		if (-INFINITY to 0) //Mostly a gimmie, this one just keeps them staggered briefly
			...
			to_chat(user, span_physique("[speaker] Your [atk_verb] briefly winds [target]."))
		...
		if (1 to 10)
			...
			to_chat(user, span_physique("[speaker] Your [atk_verb] causes [target] to tear up."))
		...
		if (11 to 30)
			...
			to_chat(user, span_physique("[speaker] Your [atk_verb] causes [target] to go stumbling about in a confuzed daze."))
		...
		if(31 to 40)
			...
			to_chat(user, span_physique("[speaker] Your [atk_verb] causes [target] to go stumbling about in a confuzed, blind daze. Nice shot."))
		...
		if (41 to 45)
			...
			to_chat(user, span_physique("[speaker] Your [atk_verb] lands, and you send [target] sailing off their feet. Good."))
		...
		if (46 to INFINITY)
			...
			to_chat(user, span_physique("[speaker] Your [atk_verb] lands, and [target] is sent crashing to the floor with the immense force. Now, finish the job."))
