...
/obj/item/hand_item/self_grasp/Destroy()
	...
	if(grasped_part)
		UnregisterSignal(grasped_part, list(COMSIG_REMOVE_LIMB, COMSIG_PARENT_QDELETING))
...
/obj/item/hand_item/self_grasp/proc/grasp_limb(obj/item/bodypart/grasping_part)
	...
	RegisterSignal(grasped_part, list(COMSIG_REMOVE_LIMB, COMSIG_PARENT_QDELETING), .proc/qdel_void)
