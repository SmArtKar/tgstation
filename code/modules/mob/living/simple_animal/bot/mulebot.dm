...
/mob/living/simple_animal/bot/mulebot/proc/run_over(mob/living/carbon/human/crushed)
	...
	crushed.deal_damage(2 * damage, BRUTE, BODY_ZONE_HEAD, MELEE)
	crushed.deal_damage(2 * damage, BRUTE, BODY_ZONE_CHEST, MELEE)
	crushed.deal_damage(0.5 * damage, BRUTE, BODY_ZONE_L_LEG, MELEE)
	crushed.deal_damage(0.5 * damage, BRUTE, BODY_ZONE_R_LEG, MELEE)
	crushed.deal_damage(0.5 * damage, BRUTE, BODY_ZONE_L_ARM, MELEE)
	crushed.deal_damage(0.5 * damage, BRUTE, BODY_ZONE_R_ARM, MELEE)
