...
/obj/item/fishing_rod/proc/get_fishing_overlays()
	...
	if(reel_overlay)
		...
		reel_appearance.appearance_flags = KEEP_APART|RESET_COLOR
	...
	if(hook || bait)
		...
		line_overlay.appearance_flags = KEEP_APART|RESET_COLOR
...
/obj/item/fishing_rod/proc/get_fishing_worn_overlays(mutable_appearance/standing, isinhands, icon_file)
	...
	reel_overlay.appearance_flags |= KEEP_APART|RESET_COLOR
