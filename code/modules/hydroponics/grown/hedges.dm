...
/obj/structure/hedge/attacked_by(obj/item/attacking_item, mob/living/user, list/modifiers)
	if(!opacity || !HAS_TRAIT(user, TRAIT_BONSAI) || !attacking_item.get_sharpness())
		return ..()
