...
/obj/item/clothing/neck/petcollar/mob_can_equip(mob/M, slot, disable_warning = FALSE, bypass_equip_delay_self = FALSE, ignore_equipped = FALSE, allow_locked = FALSE)
	if(!ismonkey(M))
		return FALSE
	return ..()
