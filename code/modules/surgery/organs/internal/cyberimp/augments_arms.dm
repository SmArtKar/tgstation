...
/obj/item/organ/cyberimp/arm/strongarm/proc/on_attack_hand(mob/living/carbon/human/source, atom/target, proximity, modifiers)
	...
	living_target.deal_damage(potential_damage * 2, attacking_bodypart.attack_type, target_zone, MELEE, armour_penetration = attacking_bodypart.unarmed_effectiveness, attack_type = UNARMED_ATTACK)
