...
/obj/item/organ/internal/eyes/slime/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/hydrophobic, 0.5, 0, BRUTE)

/obj/item/organ/internal/eyes/slime/Insert(mob/living/carbon/owner, special = FALSE)
	. = ..()
	//add lighting
	if(!adapt_light)
...
/obj/item/organ/internal/eyes/slime/Remove(mob/living/carbon/owner, special = FALSE)
	//remove lighting
	adapt_light.on = FALSE
	adapt_light.update_brightness(owner)
	adapt_light.forceMove(src)

/obj/item/organ/internal/eyes/slime/stargazer
