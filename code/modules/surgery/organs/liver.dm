...
/obj/item/organ/internal/liver/slime/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/hydrophobic, 0.5, 0, BRUTE)

/obj/item/organ/internal/liver/slime/Insert(mob/living/carbon/organ_owner, special, drop_if_replaced)
	. = ..()
...
/obj/item/organ/internal/liver/slime/Remove(mob/living/carbon/organ_owner, special)
	. = ..()
