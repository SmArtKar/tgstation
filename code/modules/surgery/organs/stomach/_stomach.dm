...
/obj/item/organ/internal/stomach/slime/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/hydrophobic, 0.5, 0, BRUTE)
	create_globule = new()

/obj/item/organ/internal/stomach/slime/Insert(mob/living/carbon/stomach_owner, special, drop_if_replaced)
	. = ..()
	create_globule.Grant(stomach_owner)

/obj/item/organ/internal/stomach/slime/Remove(mob/living/carbon/stomach_owner, special)
	. = ..()
	create_globule.Remove(stomach_owner)

/obj/item/organ/internal/stomach/slime/on_life(delta_time, times_fired)
	. = ..()
	if(create_globule)
