...
/obj/item/organ/internal/heart/slime //Handles nutrition to blood conversion
	name = "slime core"
...
/obj/item/organ/internal/heart/slime/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/hydrophobic, 0.5, 0, BRUTE)

/obj/item/organ/internal/heart/slime/on_life(delta_time, times_fired)
	. = ..()
