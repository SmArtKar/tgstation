...
/datum/reagents/plumbing/trans_to(
	...
	for(var/datum/reagent/reagent as anything in cached_reagents)
		...
		transfered_amount = target_holder.add_reagent(reagent.type, transfer_amount, chem_temp, reagent.purity, reagent.ph, no_react = TRUE, ignore_splitting = reagent.chemical_flags & REAGENT_DONOTSPLIT) //we only handle reaction after every reagent has been transferred.
