...
/obj/item/mecha_equipment/weapon/special_attaching_interaction(attach_right = FALSE, obj/vehicle/sealed/mecha/mech, mob/user, checkonly = FALSE)
	var/obj/item/mecha_equipment/concealed_weapon_bay/bay
	if(attach_right)
...
/obj/item/mecha_equipment/weapon/detach(atom/moveto)
	for(var/obj/item/mecha_equipment/concealed_weapon_bay/bay in contents)
...
/obj/item/mecha_equipment/weapon/energy/tesla
	equip_cooldown = 35
...
/obj/item/mecha_equipment/weapon/energy/plasma
	equip_cooldown = 10
...
/obj/item/mecha_equipment/weapon/energy/mecha_kineticgun
	equip_cooldown = 10
...
/obj/item/mecha_equipment/weapon/honker/action(mob/source, atom/target, list/modifiers)
	if(!action_checks(target))
		return
...
/obj/item/mecha_equipment/weapon/ballistic/get_snowflake_data()
	return list(
...
/obj/item/mecha_equipment/weapon/ballistic/handle_ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	if(action == "reload")
		rearm()
		return TRUE
...
/obj/item/mecha_equipment/weapon/ballistic/action(mob/source, atom/target, list/modifiers)
	. = ..()
	if(!.)
		return
	projectiles -= projectiles_per_shot

/obj/item/mecha_equipment/weapon/ballistic/carbine
...
/obj/item/mecha_equipment/weapon/ballistic/silenced
...
/obj/item/mecha_equipment/weapon/ballistic/missile_rack
...
/obj/item/mecha_equipment/weapon/ballistic/missile_rack/breaching
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/flashbang/proj_init(obj/item/grenade/flashbang/F, mob/user)
	var/turf/T = get_turf(src)
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/flashbang/clusterbang //Because I am a heartless bastard -Sieve //Heartless? for making the poor man's honkblast? - Kaze
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/mousetrap_mortar
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/mousetrap_mortar/proj_init(obj/item/assembly/mousetrap/armed/M)
	M.secured = TRUE

//Classic extending punching glove, but weaponised!
/obj/item/mecha_equipment/weapon/ballistic/launcher/punching_glove
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/punching_glove/get_snowflake_data()
	. = ..()
	.["mode"] = harmful ? "LETHAL FISTING" : "Cuddles"
	.["mode_label"] = "Honk Severity"

/obj/item/mecha_equipment/weapon/ballistic/launcher/punching_glove/handle_ui_act(action, list/params)
	. = ..()
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/punching_glove/action(mob/source, atom/target, list/modifiers)
	. = ..()
	if(.)
		to_chat(usr, "[icon2html(src, usr)]<font color='red' size='5'>HONK</font>")

/obj/item/mecha_equipment/weapon/ballistic/launcher/punching_glove/proj_init(obj/item/punching_glove/PG)
	if(!istype(PG))
		return
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/banana_mortar/bombanana
...
/obj/item/mecha_equipment/weapon/ballistic/launcher/flashbang/tearstache
...
/obj/item/mecha_equipment/weapon/paddy_claw/attach(obj/vehicle/sealed/mecha/new_mecha)
	. = ..()
	secmech = chassis

/obj/item/mecha_equipment/weapon/paddy_claw/detach(atom/moveto)
	secmech = null
	return ..()

/obj/item/mecha_equipment/weapon/paddy_claw/action(mob/source, atom/target, list/modifiers)
...
/obj/item/mecha_equipment/weapon/paddy_claw/get_snowflake_data()
	return list(
		"snowflake_id" = MECHA_SNOWFLAKE_ID_CLAW,
		"autocuff" = autocuff,
	)

/obj/item/mecha_equipment/weapon/paddy_claw/handle_ui_act(action, list/params)
	switch(action)
		if("togglecuff")
			autocuff = !autocuff
			return TRUE
