...
/datum/status_effect/webbed
	...
	var/mutable_appearance/web_underlay

/datum/status_effect/webbed/on_apply()
	owner.add_movespeed_modifier(/datum/movespeed_modifier/webbed)
	web_underlay = mutable_appearance('icons/effects/effects.dmi', "web_overlay")
	web_underlay.pixel_x = owner.pixel_x
	web_underlay.pixel_y = owner.pixel_y
	owner.underlays += web_underlay
	return TRUE
