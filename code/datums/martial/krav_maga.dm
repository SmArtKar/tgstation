...
/datum/martial_art/krav_maga/proc/neck_chop(mob/living/attacker, mob/living/defender)
	...
	playsound(attacker, 'sound/effects/hit_punch.ogg', 50, TRUE, -1)
	defender.apply_damage_package(attacker.get_unarmed_package(defender, 10, null, BODY_ZONE_HEAD))
...
/datum/martial_art/krav_maga/harm_act(mob/living/attacker, mob/living/defender)
	...
	defender.apply_damage_package(attacker.get_unarmed_package(defender, 10 + bonus_damage, null, defender.get_random_valid_zone(attacker.zone_selected)))
