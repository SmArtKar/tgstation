...
/datum/symptom/heal/starlight/passive_message_condition(mob/living/M)
	if(M.get_brute_loss() || M.get_burn_loss() || M.get_tox_loss())
		return TRUE
	return FALSE
...
/datum/symptom/heal/darkness/passive_message_condition(mob/living/M)
	if(M.get_brute_loss() || M.get_burn_loss())
		return TRUE
	return FALSE
...
/datum/symptom/heal/coma/CanHeal(datum/disease/advance/A)
	...
	switch(M.stat)
		...
		if(SOFT_CRIT)
			return power * 0.5
	if(M.get_brute_loss() + M.get_burn_loss() >= 70 && !active_coma)
...
/datum/symptom/heal/coma/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	if(active_coma && M.get_brute_loss() + M.get_burn_loss() == 0)
		uncoma(M)

	return 1

/datum/symptom/heal/coma/passive_message_condition(mob/living/M)
	if((M.get_brute_loss() + M.get_burn_loss()) > 30)
		return TRUE
	return FALSE
...
/datum/symptom/heal/water/passive_message_condition(mob/living/carbon/infected_mob)
	if(infected_mob.get_brute_loss() || infected_mob.get_burn_loss())
		return TRUE
