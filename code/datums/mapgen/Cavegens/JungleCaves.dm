...
/datum/map_generator/cave_generator/jungle/deep
	flora_spawn_list = list(/obj/structure/flora/rock = 2, /obj/structure/flora/rock/pile = 4, /obj/structure/flora/grass/jungle/b = 2, /obj/structure/flora/rock/jungle = 1, /obj/structure/flora/ash/jungle_plant/beerroot = 2)
	mob_spawn_chance = 8
