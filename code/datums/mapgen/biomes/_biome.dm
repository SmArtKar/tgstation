...
/datum/biome
	...
	var/list/fauna_types = list(/mob/living/simple_animal/hostile/jungle/leaper, /mob/living/simple_animal/hostile/jungle/seedling, /mob/living/simple_animal/hostile/jungle/mook, /mob/living/simple_animal/hostile/jungle/mega_arachnid)
