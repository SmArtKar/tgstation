...
/datum/component/embedded/Initialize(obj/item/weapon,
	...
	if(damage > 0)
		var/armor = victim.run_armor_check(limb.body_zone, MELEE, "Your armor has protected your [limb.plaintext_zone].", "Your armor has softened a hit to your [limb.plaintext_zone].", weapon.armour_penetration, weak_against_armour = weapon.weak_against_armour, attack_type = THROWN_PROJECTILE_ATTACK)
