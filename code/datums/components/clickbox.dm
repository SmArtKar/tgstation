...
/datum/component/clickbox/proc/update_underlay(clickbox_icon_state, width, height)
	...
	clickbox_underlay = mutable_appearance('icons/ui/clickbox.dmi', clickbox_icon_state, CLICKBOX_LAYER, alpha = 1, appearance_flags = KEEP_APART|RESET_COLOR|RESET_ALPHA)
