...
/turf/open/openspace/icemoon/Initialize(mapload)
	...
	M.mineralAmt = 0
	M.gets_drilled()
	baseturfs = type //This is to ensure that IF random turf generation produces a openturf, there won't be other turfs assigned other than openspace.
...
/turf/open/openspace/icemoon/jungle/keep_below
	drill_below = FALSE

/turf/open/openspace/icemoon/jungle/ruins
	protect_ruin = FALSE
	drill_below = FALSE
