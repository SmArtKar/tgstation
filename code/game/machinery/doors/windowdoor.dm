...
/obj/machinery/door/window/rust_heretic_act()
	...
	take_damage(get_integrity() * 0.5, attack_type = MELEE_ATTACK, attack_type = MAGIC_ATTACK)
...
/obj/machinery/door/window/atmos_expose(datum/gas_mixture/air, exposed_temperature)
	take_damage(round(exposed_temperature / 200), BURN, NONE, FALSE, attack_type = ENVIRONMENTAL_ATTACK)
