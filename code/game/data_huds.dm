...
/proc/RoundHealth(mob/living/M)
	...
	if(iscarbon(M) && M.health < 0)
		maxi_health = 100
	 //so crit shows up right for aliens and other high-health carbon mobs; noncarbons don't have crit.
	var/resulthealth = (M.health / maxi_health) * 100
	return "health[RoundValue(resulthealth)]"

/proc/RoundValue(value)
	switch(value)
		if(100 to INFINITY)
			return "100"
		if(90.625 to 100)
