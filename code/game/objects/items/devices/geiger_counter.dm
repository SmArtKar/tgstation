...
/obj/item/geiger_counter/examine(mob/user)
	...
	switch(last_perceived_radiation_danger)
		if(null)
			. += result.show_message("Ambient radiation level count reports that all is well.")
		if(PERCEIVED_RADIATION_DANGER_LOW)
			. += result.show_message("Ambient radiation levels slightly above average.")
		if(PERCEIVED_RADIATION_DANGER_MEDIUM)
			. += result.show_message("Ambient radiation levels above average.")
		if(PERCEIVED_RADIATION_DANGER_HIGH)
			. += result.show_message("Ambient radiation levels highly above average.")
		if(PERCEIVED_RADIATION_DANGER_EXTREME)
			. += result.show_message("Ambient radiation levels reaching critical level!")
