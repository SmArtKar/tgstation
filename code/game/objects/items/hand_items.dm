...
/obj/item/hand_item/circlegame/proc/selfGottem(mob/living/owner)
	...
	owner.apply_damage(100, STAMINA, hit_by = src, source = owner)
	owner.Knockdown(10)
	qdel(src)
...
/obj/item/hand_item/circlegame/proc/GOTTEM(mob/living/owner, mob/living/sucker)
	...
	if(HAS_TRAIT(owner, TRAIT_HULK))
		...
		sucker.apply_damage(50, STAMINA, hit_by = src, source = owner)
		sucker.Knockdown(50)
		...
		sucker.apply_damage(15, STAMINA, hit_by = src, source = owner)
...
/obj/item/hand_item/noogie/proc/noogie_loop(mob/living/carbon/human/user, mob/living/carbon/target, iteration)
	...
	target.apply_damage(damage, BRUTE, MELEE, UNARMED_ATTACK, BODY_ZONE_HEAD, hit_by = user, source = user, check_armor = TRUE)
