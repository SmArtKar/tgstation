...
/obj/structure/proc/smash_and_injure(mob/living/flying_mob, atom/oldloc, direction)
	...
	flying_mob.deal_damage(rand(5, 15), BRUTE, null, MELEE, wound_bonus = 15, bare_wound_bonus = 25, sharpness = SHARP_EDGED, attack_direction = get_dir(src, oldloc), attack_type = ENVIRONMENTAL_ATTACK|SLAM_ATTACK)
