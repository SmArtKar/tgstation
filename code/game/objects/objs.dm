...
/obj/handle_ricochet(obj/projectile/proj)
	...
	if(. && receive_ricochet_damage_coeff)
		var/datum/damage_package/package = proj.generate_damage(src)
		package.amount *= receive_ricochet_damage_coeff
		take_damage(direct_package = package, sound_effect = FALSE) // pass along receive_ricochet_damage_coeff damage to the structure for the ricochet
