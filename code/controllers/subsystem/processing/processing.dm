 ...
 * - Damaging a mob, do `L.adjust_burn_loss(20 * seconds_per_tick)`, not `L.adjust_burn_loss(20)`. This way, the damage per second stays constant even if the wait of the subsystem is changed
