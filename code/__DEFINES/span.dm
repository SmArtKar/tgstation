...
#define span_intellect(str) ("<span class='intellect'>" + str + "</span>")
#define span_intellect_bold(str) ("<span class='intellect bold'>" + str + "</span>")
#define span_intellect_italic(str) ("<span class='intellect italics'>" + str + "</span>")
#define span_intellect_italic_bold(str) ("<span class='intellect italics bold'>" + str + "</span>")
...
#define span_motorics(str) ("<span class='motorics'>" + str + "</span>")
#define span_motorics_bold(str) ("<span class='motorics bold'>" + str + "</span>")
#define span_motorics_italic(str) ("<span class='motorics italics'>" + str + "</span>")
#define span_motorics_italic_bold(str) ("<span class='motorics italics bold'>" + str + "</span>")
...
#define span_psyche(str) ("<span class='psyche'>" + str + "</span>")
#define span_psyche_bold(str) ("<span class='psyche bold'>" + str + "</span>")
#define span_psyche_italic(str) ("<span class='psyche italics'>" + str + "</span>")
#define span_psyche_italic_bold(str) ("<span class='psyche italics bold'>" + str + "</span>")
#define span_purple(str) ("<span class='purple'>" + str + "</span>")
#define span_physique(str) ("<span class='physique'>" + str + "</span>")
#define span_physique_bold(str) ("<span class='physique bold'>" + str + "</span>")
#define span_physique_italic(str) ("<span class='physique italics'>" + str + "</span>")
#define span_physique_italic_bold(str) ("<span class='physique italics bold'>" + str + "</span>")
