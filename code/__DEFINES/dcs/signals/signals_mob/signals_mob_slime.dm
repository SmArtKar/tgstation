...
/// From mob/living/simple_animal/slime/Feedon(atom/target): (atom/target)
#define COMSIG_SLIME_FEEDON "slime_feedon"
/// From mob/living/simple_animal/slime/Feedstop(silent, living): (atom/target)
#define COMSIG_SLIME_FEEDSTOP "slime_feedstop"
/// From mob/living/simple_animal/slime/AIprocess(): ()
