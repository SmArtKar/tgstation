...
#define SMOOTH_GROUP_FLOOR_GRASS_JUNGLE S_TURF(6) ///turf/open/floor/plating/grass/jungle
#define SMOOTH_GROUP_FLOOR_DIRT S_TURF(7) ///turf/open/floor/plating/dirt
#define SMOOTH_GROUP_FLOOR_ASH S_TURF(8) ///turf/open/floor/plating/ashplanet/ash
#define SMOOTH_GROUP_FLOOR_ASH_ROCKY S_TURF(9) ///turf/open/floor/plating/ashplanet/rocky
#define SMOOTH_GROUP_FLOOR_ICE S_TURF(10) ///turf/open/floor/plating/ice
#define SMOOTH_GROUP_FLOOR_SNOWED S_TURF(11) ///turf/open/floor/plating/snowed
...
#define SMOOTH_GROUP_CLOSED_TURFS S_TURF(55) ///turf/closed
#define SMOOTH_GROUP_MATERIAL_WALLS S_TURF(56) ///turf/closed/wall/material
#define SMOOTH_GROUP_SYNDICATE_WALLS S_TURF(57) ///turf/closed/wall/r_wall/syndicate, /turf/closed/indestructible/syndicate
#define SMOOTH_GROUP_HOTEL_WALLS S_TURF(58) ///turf/closed/indestructible/hotelwall
#define SMOOTH_GROUP_MINERAL_WALLS S_TURF(59) ///turf/closed/mineral, /turf/closed/indestructible
