...
#define SMOOTH_GROUP_BRONZE_TABLES S_OBJ(54) ///obj/structure/table/reinforced/bronze
#define SMOOTH_GROUP_ABDUCTOR_TABLES S_OBJ(55) ///obj/structure/table/reinforced/abductor
