...
#define DAMAGE_PACKAGE(amount, damage_type, damage_flag, attack_flags, def_zone, attack_dir, armor_penetration, armor_multiplier, forced, hit_by, source, attack_text, attack_message_spectator, attack_message_attacker, wound_bonus, bare_wound_bonus, sharpness)\
	(new /datum/damage_package(amount, damage_type, damage_flag, attack_flags, def_zone, attack_dir, armor_penetration, armor_multiplier, forced, hit_by, source, attack_text, attack_message_spectator, attack_message_attacker, wound_bonus, bare_wound_bonus, sharpness))
